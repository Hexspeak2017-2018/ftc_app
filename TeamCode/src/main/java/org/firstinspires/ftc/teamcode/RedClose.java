...
@Autonomous(name="RedClose",group = "Red Autonomus")
    ...
    public void runOpMode() throws InterruptedException {
        try {
            ...
            if (robot.colorSensor.blue() < robot.colorSensor.red()) {
                ...
                telemetry.update();
                robot.driveForwardInches(3,0.4,1);
                sleep(500);
